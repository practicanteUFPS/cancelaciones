                    ...
                    <tr>
                        ...
                        <td <?= $data->PORCENTAJE_INACTIVOS == 0 ? 'title="No hay estudiantes para mostrar"' : '' ?>>
                            <?php if ($data->PORCENTAJE_INACTIVOS > 0): ?>
                                <a href="<?= site_url("alumno/buscar_inactivos_tabla_semestre/$anio/$num_semestre") ?>"
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="Para este semestre <?= $data->INACTIVOS; ?> alumnos pasaron a ser inactivos. Presiona para ver el listado de estudiantes inactivos">
                        ...
                        <td <?= $data->PORCENTAJE_ACTIVOS == 0 ? 'title="No hay estudiantes para mostrar"' : '' ?>>
                            <?php if ($data->PORCENTAJE_ACTIVOS > 0): ?>
                                <a href="<?= site_url("alumno/buscar_activos_tabla_semestre/$anio/$num_semestre") ?>"
                        ...
                        <td <?= $data->PORCENTAJE_GRADUADOS == 0 ? 'title="No hay estudiantes para mostrar"' : '' ?>>
                            <?php if ($data->PORCENTAJE_GRADUADOS > 0): ?>
                                <a href="<?= site_url("exalumno/lista_graduados_semestre/$anio/$num_semestre") ?>"
