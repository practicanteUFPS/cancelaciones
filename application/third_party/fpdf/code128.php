...
//________________ Fonction encodage et dessin du code 128 _____________________
     ...
     * @param type $w
     * @param type $h
     * @param type $saltos Array que contiene las posiciones en donde se incrustaran los caracteres FNC1 y asi dar el formato GS1-128/EAN-128
     */
    function Code128($x, $y, $code, $w, $h, $saltos = array(0)) {
        ...
        for ($i = 0; $i < count($saltos); $i++) {
            $crypt = substr_replace($crypt, chr(102), ($saltos[$i] + $i), 0);
        }
        /*
          $crypt = substr_replace($crypt, chr(102), 1,0);
          $crypt = substr_replace($crypt, chr(102), 17,0);
          $crypt = substr_replace($crypt, chr(102), 24,0);
         */
        ...
        for ($i = 0; $i < strlen($crypt); $i++) {                                      // BOUCLE D'IMPRESSION
            ...
            /*
             * Color para el codigo de barras
             */
            /*
              if (($i % 2) == 0) {
            ...
            /*
              ...
              $cadena_gen .= '(FNC1)-102' . '(' . $i . ')-' . ord($crypt[$i]);
              $c=  array_merge($this->T128[102],$this->T128[ord($crypt[$i])]);

              } else {
              $cadena_gen .= '(' . $i . ')-' . ord($crypt[$i]);
        ...
        /*
         * Muestra la cadena que escribio en el codigo de barras
         */
        /*
          $this->Write(10, $cadena_gen);
          $this->Write(10, "tamaño de crypt".strlen($crypt));
          $this->Write(10, $crypt);
         *
         */
    }
